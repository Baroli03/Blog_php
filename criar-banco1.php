...
$inserindo = [
    ...
    "INSERT IGNORE INTO posts (admin_id, titulo, conteudo) VALUES (1, 'Primeiro Post do Blog', 'Bem-vindo ao meu novo blog! Este é o primeiro post de muitos.')",
    "INSERT IGNORE INTO posts (admin_id, titulo, conteudo) VALUES (1, 'Sobre Desenvolvimento Web', 'Neste post, exploraremos as últimas tendências em desenvolvimento web e suas tecnologias.')",
    "INSERT IGNORE INTO posts (admin_id, titulo, conteudo) VALUES (1, 'Dicas para Programadores Iniciantes', 'Compartilhando algumas dicas valiosas para quem está começando no mundo da programação.')",
    "INSERT IGNORE INTO posts (admin_id, titulo, conteudo) VALUES (1, 'A Importância do Design Responsivo', 'Discutindo por que o design responsivo é crucial para a experiência do usuário hoje em dia.')",
